...
const quizInfo = {
  cassandraDeveloper: {
    title: "Cassandra Developer Certification",
    desc: "CQL、データモデリング、パーティション設計、整合性、レプリケーション、運用基礎"
  },
  cockroachdbProfessional: {
    title: "CockroachDB Certified Professional",
    desc: "分散SQL、トランザクション、レンジ、レプリカ、マルチリージョン、運用・障害対応"
  },
  singlestoreDeveloper: {
    title: "SingleStore Certified Developer",
    desc: "分散SQL、行/列ストア、シャードキー、パイプライン、HTAP、クエリ最適化"
  }
};
...
if (type === "all") {
  document.title = "Cassandra・CockroachDB・SingleStore資格クイズ";
  pageTitle.textContent = "Cassandra・CockroachDB・SingleStore資格クイズ";
  pageDesc.textContent = "3カテゴリ・各180問から50問ランダムで出題";
} else {
  const info = quizInfo[type] || quizInfo.cassandraDeveloper;
